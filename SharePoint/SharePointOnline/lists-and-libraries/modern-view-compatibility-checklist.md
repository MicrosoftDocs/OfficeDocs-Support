...
**Recommendation:** Create a view that doesn't include External Data Columns(s) or Remove the External Data Column(s) from the current View. You don't have to remove the Column(s) from the List or Library.
...
remove the Publishing Columns(s) from the current View. You don't have to remove the Column(s) from the List or Library.
