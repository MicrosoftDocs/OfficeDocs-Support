...
Important: Prior to deleting a root site collection, Admins are made aware of the consequences of deleting the root site collection with the following message. 
