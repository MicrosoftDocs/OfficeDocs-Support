...
The data from the classic popularity reports will not be available after August 7, 2020. If it's required, you can download and save historical data from these reports before August 7, 2020. To learn more about downloading the classic usage reports in Excel, please refer to our [support article](https://docs.microsoft.com/sharepoint/view-popularity-trends-and-most-popular-items).
...
Customers who use our sovereign cloud offering and belong to Gallatin (operated by 21Vianet), GCC High or DoD environments will not be able to access the modern site usage page or the GetItemAnalytics API since the back-end capabilities required to enable these features are not present in these environments.
