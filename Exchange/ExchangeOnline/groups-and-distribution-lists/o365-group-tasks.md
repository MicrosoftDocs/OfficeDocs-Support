...
- Microsoft 365 Groups creation & display
  ...
  - [Display an Microsoft 365 group associated with a team](#display-an-microsoft-365-group-associated-with-a-team)
- Microsoft 365 group delegation
  - [Enable specific users to "Send As" an Microsoft 365 group](#enable-specific-users-to-send-as-an-microsot-365-group)
...
- Microsoft 365 Groups email address management
  ...
  - [Add or remove a secondary email address from an Microsoft 365 Group](#add-or-remove-a-secondary-email-address-from-an-microsoft-365-group)
...
- Other tasks
  - [Restore an Microsoft 365 Group](#restore-an-microsoft-365-group)
  - [Convert to an Microsoft 365 group](#convert-to-an-microsoft-365-group)
...
- Microsoft 365 Groups expiration policy
  ...
  [Microsoft 365 group expiration policy](/microsoft-365/admin/create-groups/office-365-groups-expiration-policy?view=Microsoft 365-worldwide&preserve-view=true)
...
- Microsoft 365 group naming policy
  ...
  Worried that users might give offensive names to the Microsoft 365 groups that they create? Use the Microsoft 365 Groups naming policy to block specific words and limit group names to certain criteria, such as department names. See [Microsoft 365 Groups naming policy](/microsoft-365/admin/create-groups/groups-naming-policy?view=Microsoft 365-worldwide&preserve-view=true).

[Back to top](#summary)

### Display an Microsoft 365 group associated with a team
...
### Enable specific users to Send As an Microsoft 365 group

You can assign "Send As" permissions to allow specific users to send messages on behalf of an Microsoft 365 group:
...
For more information, see [Allow members to send as or send on behalf of a Group](/microsoft-365/admin/create-groups/allow-members-to-send-as-or-send-on-behalf-of-group?view=Microsoft 365-worldwide&preserve-view=true).

[Back to top](#summary)

### Control user access to specific group resources

A Microsoft 365 group has many more resources but following are minimum:
...
|Distribution Group as a member of an Microsoft 365 group|A distribution group that has more than 1,000 members cannot be added to an Microsoft 365 group. This also includes the nested distribution group members.|
|||
...
You can create an email address policy to automatically stamp customized email addresses onto Microsoft 365 groups. See [Choose the domain to use when creating Microsoft 365 Groups](/microsoft-365/admin/create-groups/choose-domain-to-create-groups?view=Microsoft 365-worldwide&preserve-view=true).
...
foreach ($Microsoft365Group in $Microsoft 365Groups)
{
...
Restoring an Microsoft 365 group restores any services that are related to the group, such as Planner, Teams, and SharePoint sites.
...
Use the [Microsoft 365 Admin center](https://aka.ms/RestoreDeletedGroup) or Azure Active Directory (Azure AD) PowerShell to restore a deleted group. See [Restore a deleted Microsoft 365 Group](/microsoft-365/admin/create-groups/restore-deleted-group?view=Microsoft 365-worldwide&preserve-view=true).

[Back to top](#summary)

### Convert to Microsoft 365 group

Microsoft provides no tools to convert a shared mailbox to Microsoft 365 group, or vice versa.
...
Use the Microsoft 365 compliance search to export email contents of a Microsoft 365 group to PST. Please use [this](https://docs.microsoft.com/en-us/microsoft-365/compliance/search-for-content?view=o365-worldwide) article for detailed steps.

You can run PowerShell commands to accomplish the following tasks.

Export the membership list of an Microsoft 365 group:
